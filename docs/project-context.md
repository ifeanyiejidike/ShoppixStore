...
PROJECT: Shoppix
STAGE: active build
LAST UPDATED: 2026-08-21 (0 days ago) — Backend dir renamed shoppix-backend→shoppix_backend and this file moved to docs/project-context.md (user's change); swept entire repo for stale references, confirmed zero remain
LIVE BLOCKER: none

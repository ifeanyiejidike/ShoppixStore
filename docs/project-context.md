...
PROJECT: Shoppix
STAGE: active build
LAST UPDATED: 2026-08-21 (0 days ago) — Rewrote all three READMEs (root/frontend/backend) from scratch to enterprise-grade depth; fixed this file's own stale front matter (version/date hadn't tracked the changelog)
LIVE BLOCKER: none
